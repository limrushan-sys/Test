...
export const ITEM_COLLISION: Record<ItemType, ItemCollisionData> = {
  [ItemType.SLEEPING_HIDE]:   { radius: 0.45, height: 0,    climbable: false, footprint: 0.50,
    circles: [[-0.50, 0, 0.25], [-0.17, 0, 0.25], [0.17, 0, 0.25], [0.50, 0, 0.25],
              [-0.50, 0.20, 0.20], [-0.17, 0.20, 0.20], [0.17, 0.20, 0.20], [0.50, 0.20, 0.20],
              [-0.50,-0.20, 0.20], [-0.17,-0.20, 0.20], [0.17,-0.20, 0.20], [0.50,-0.20, 0.20]] },
  ...
  [ItemType.PLATFORM]:        { radius: 0.55, height: 0,    climbable: false, footprint: 0.60,
    circles: [[-0.38, -0.25, 0.28], [0, -0.25, 0.28], [0.38, -0.25, 0.28],
              [-0.38,  0.25, 0.28], [0,  0.25, 0.28], [0.38,  0.25, 0.28],
              [-0.38,  0,    0.28], [0,  0,    0.28], [0.38,  0,    0.28]] },
